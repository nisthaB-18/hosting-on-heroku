...
class Decode:
    ...
    def __init__(self,image_path, password):
        ...
        # self.text_to_encode = text_to_decode.strip() if text_to_decode else None
        # perform encoding logic using self.image_path, self.password, and self.text_to_encode)
    ...
    def decode_from_image(self):
        if self.is_password_valid():
            ...
            # raw_image = Image.open("./temp_image.png") #raw_image = Image.open("./saved.png")
