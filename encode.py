...
class Encode:
    ...
    def is_image_path_valid(self):
        ...
        if os.path.exists(self.image_path):
            return True
        return False
    #Check if all the supplied values for the argument are correct
    def are_values_valid(self):
        ...
        if not self.is_password_valid():
            ...
            print("Text to encode can't be empty.")
            return False
        # elif not self.is_image_path_valid():
        #     print("Selected image doesn't exist anymore.")
        #     return False
        else:
            #Validated
            return  True
    ...
    def encode_into_image(self):
        ...
        if self.are_values_valid():
            # reading the image in read only mode from the supplied path
            raw_image = Image.open("./temp_image.png")
                ...
                if int(secret_hash) > image_size:
                    ...
                    if int(secret_hash) > image_size:
                        ...
                        if int(secret_hash) > image_size:
                            ...
                            if int(secret_hash) > image_size:
                                print['Image size is not sufficient to encode the given text.']
                                return  False
